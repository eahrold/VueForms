...
export const ValidationSync = function(validation) {
    return {
        mounted() {
            validation.$on(VALIDATION_EVENT_REGISTRY_CHANGED, this.didUpdateValidationRegistry)
        },

        beforeDestory() {
            validation.$off(VALIDATION_EVENT_REGISTRY_CHANGED, this.didUpdateValidationRegistry)
        },
